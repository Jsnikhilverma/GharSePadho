    ...
    <div className="bg-gradient-to-b from-gray-50 to-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Our dedicated team is ready to help you find the perfect tutor for your educational journey.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          {/* Contact Form */}
          <div className="bg-white rounded-xl shadow-xl p-8 md:p-10 border border-gray-200">
            <div className="mb-8">
              <div className="bg-blue-700 text-white text-xs font-semibold px-4 py-2 rounded-full inline-block mb-4">
                SEND US A MESSAGE
              </div>
          ...
          <div>
            ...
            <div className="mt-12 bg-gray-50 p-6 rounded-xl border border-gray-200">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-indigo-50 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-6">
            Common Questions About Our <span className="text-blue-700">Tutoring Services</span>
          </h2>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          {[
            {
              question: "How do I select the right tutor for my needs?",
              answer: "Our academic advisors will assess your requirements and match you with 2-3 suitable tutors. You can then schedule introductory sessions with each before making your final selection."
            },
            {
              question: "What safety measures do you have for in-person tutoring?",
              answer: "All our tutors undergo rigorous background checks. For in-person sessions, we recommend public spaces or our learning centers. We also offer session tracking and feedback systems."
            },
            {
              question: "Can I change tutors if I'm not satisfied?",
              answer: "Absolutely. We offer a no-questions-asked tutor replacement policy within the first 3 sessions if you're not completely satisfied with your match."
            },
            {
              question: "What subjects and grade levels do you cover?",
              answer: "We provide tutoring for all core subjects from Class 1 through college level, including specialized test preparation for Indian and international entrance exams."
            }
          ].map((item, index) => (
            <div key={index} className="mb-6 border border-gray-200 rounded-xl overflow-hidden">
              <button className="flex justify-between items-center w-full px-6 py-4 bg-gray-50 hover:bg-gray-100 focus:outline-none transition-colors">
